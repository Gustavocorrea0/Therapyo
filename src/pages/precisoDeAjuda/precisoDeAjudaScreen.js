    ...
    <SafeAreaView style={styles.container}>
      <ScrollView contentContainerStyle={{ flexGrow: 1, justifyContent: 'center' }} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.containerBranco}>
          ...
          <TouchableOpacity style={[styles.botaoUm, {marginTop: 20}]} onPress={() => navigation.navigate('CrisesDeAnsiedade')}>
            <Text style={styles.tituloBotoes}>Crise de Ansiedade</Text>
            
          </TouchableOpacity>

          <TouchableOpacity style={[styles.botaoDois, {marginTop: 20}]} onPress={() => navigation.navigate('Outro')}>
